...
wasm:
	...
	@ emcc $(BUILD_DIR)/lib.so -o ../online/src/service/nat/wasm/nat.js -s EXPORT_ES6=1 -s MODULARIZE=1 -s EXPORTED_RUNTIME_METHODS=ccall,cwrap,print,FS -s EXPORTED_FUNCTIONS=_vmInterpretSource,_vmNLS -s STACK_SIZE=5MB -sALLOW_MEMORY_GROWTH --embed-file src/core